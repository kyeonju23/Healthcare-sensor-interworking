...
# 객체 생성
# y-axis setting
scope_ppg = Scope(ax,insert, ystart = 0, ymax = 3)
scope_beat = Scope1(ax,insert_beat, ystart = 0, ymax = 3)

# update 매소드 호출

ani = animation.FuncAnimation(fig, scope_ppg.update,interval=0.01,blit=1),animation.FuncAnimation(fig, scope_beat.update,interval=0.01,blit=1)

plt.show()

ani.save('plt.gif',writer='imagemagick',fps=30)
